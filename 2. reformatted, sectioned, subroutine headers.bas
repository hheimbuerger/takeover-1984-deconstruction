...
18 DATA WILL NOT
19 GOSUB 6000: REM INSTR. & QUESTIONS
...
90 GOSUB 8000: PRINT "�": POKE UB, U3: POKE UG, U1: GOSUB 8100

// *** Main Game Loop ***
95 GOSUB 8300: GOTO 98
96 GOSUB 3000: REM NEWS
98 FOR Q = 1 TO 4
100 GOSUB 8200: A$ = "": B$ = "": N1 = 0: GOSUB 9000
145 X = 0: Y = 0
150 GOSUB 8000
...
200 GOSUB 8200: PRINT U6$; "";
205 IF B5(Y, X) <> 0 THEN 210
206 GOTO 215
210 PRINT "THERE'S A BUILDING ON SQUARE " B$; A$: GOSUB 8050
212 GOTO 100
215 IF M5(Y, X) < 0 THEN 220
216 GOTO 225
220 PRINT "YOU ALREADY HOLD SQUARE " B$; A$: GOSUB 8050
222 GOTO 100
225 REM OK TO TAKE

230 FOR K = 1 TO 2: D9$ = U1$: GOSUB 8110: D9$ = "": GOSUB 8110: NEXT K
...
260 GOSUB 8050: GOTO 1000
300 REM SQUARE CHANGES HANDS
310 M5(Y, X) = -1: GOSUB 8110
320 GOTO 198
...
458 GOSUB 8050: GOTO 100
460 PRINT "" WF$(B); " JOIN THE REBELS."
462 GOSUB 8050: IF N1 = 1 THEN 100
470 FOR K = 1 TO 3: D9$ = U1$: GOSUB 8110: D9$ = U0$: GOSUB 8110: NEXT K
472 GOSUB 8200: D9$ = ""
473 K = INT(RND(1) * 3 + 2)
474 IF B < K THEN 480
475 IF B > K THEN 490
...
479 M5(Y, X) = 0: GOSUB 8110: GOSUB 8350: GOSUB 8050: GOTO 1000
480 PRINT UM$; "THE " B$(J)
482 PRINT "VOTES TO JOIN THE REBELS!"
483 P3 = P3 + S(J): IF M5(Y, X) > 0 THEN G3 = G3 - S(J)
484 M5(Y, X) = -1: GOSUB 8110
485 P2 = P2 + .125: G2 = G2 - .125: GOSUB 8350
486 GOSUB 8050: GOTO 198
490 PRINT UN$; "THE " B$(J)
492 PRINT "SIDES WITH THE GOVERNMENT FORCES."
493 G3 = G3 + S(J): IF M5(Y, X) < 0 THEN P3 = P3 - S(J)
494 M5(Y, X) = 1: GOSUB 8110
495 G2 = G2 + .125: P2 = P2 - .125: GOSUB 8350
496 GOSUB 8050: GOTO 1000
...
2250 FOR K = 1 TO 6: D9$ = U1$: GOSUB 8110: D9$ = U0$: GOSUB 8110: NEXT K
2252 GOSUB 8200: D9$ = ""
...
2264 M5(Y, X) = 0: GOSUB 8110
2267 GOSUB 8350
2268 GOSUB 8050: GOTO 96
2270 PRINT UM$; "THE " B$(J)
2272 PRINT "VOTES TO JOIN THE REBELS!"
2274 P3 = P3 + S(J): IF M5(Y, X) > 0 THEN G3 = G3 - S(J)
2275 M5(Y, X) = -1: GOSUB 8110
2276 P2 = P2 + .125: G2 = G2 - .125: GOSUB 8350
2278 GOSUB 8050: GOTO 96
2280 PRINT UN$; "THE " B$(J)
2282 PRINT "SIDES WITH THE GOVERNMENT FORCES."
2284 G3 = G3 + S(J): IF M5(Y, X) < 0 THEN P3 = P3 - S(J)
2286 M5(Y, X) = 1: GOSUB 8110
2287 G2 = G2 + .125: P2 = P2 - .125: GOSUB 8350
2288 GOSUB 8050: GOTO 2097

// *** Computer Takes Over a Square ***
2600 REM COMPUTER TAKES OVER A SQUARE
2610 FOR K = 1 TO 2: D9$ = U1$: GOSUB 8110: D9$ = "": GOSUB 8110: NEXT K
2620 M5(Y, X) = 1: GOSUB 8110: GOSUB 8050
2630 GOTO 2097
...
3080 FOR L = 1 TO 4: D9$ = U1$: GOSUB 8110: D9$ = "": GOSUB 8110: NEXT L
...
3160 FOR K = 1 TO 20: GOSUB 4200: NEXT K: GOSUB 8050: RETURN
3170 FOR K = 1 TO 20: GOSUB 4300: NEXT K: GOSUB 8050: RETURN
...
3260 FOR K = 1 TO 12: GOSUB 4200: NEXT K: GOSUB 8050: RETURN
3270 FOR K = 1 TO 12: GOSUB 4300: NEXT K: GOSUB 8050: RETURN
...
3360 GOSUB 4000: GOSUB 8050: RETURN
3370 GOSUB 4100: GOSUB 8050: RETURN
...
3450 IF M5(Y, X) = 0 THEN FOR K = 1 TO 20: GOSUB 4400: NEXT K: GOSUB 8050: RETURN
3455 IF M5 = 1 THEN 3470
3460 FOR K = 1 TO 10: GOSUB 4200: NEXT K: GOSUB 8050: RETURN
3470 FOR K = 1 TO 10: GOSUB 4300: NEXT K: GOSUB 8050: RETURN
...
3560 GOSUB 4000: GOSUB 8050: RETURN
3570 GOSUB 4100: GOSUB 8050: RETURN
...
3660 FOR K = 1 TO 12: GOSUB 4200: NEXT K: GOSUB 8050: RETURN
3670 FOR K = 1 TO 12: GOSUB 4300: NEXT K: GOSUB 8050: RETURN
...
3760 GOSUB 4000: GOSUB 8050: RETURN
3770 GOSUB 4100: GOSUB 8050: RETURN
...
4240 D9$ = U1$: GOSUB 8110: D9$ = "": GOSUB 8110
4245 M5(Y, X) = -1
4250 D9$ = U1$: GOSUB 8110: D9$ = "": GOSUB 8110
4260 RETURN
...
4340 D9$ = U1$: GOSUB 8110: D9$ = "": GOSUB 8110
4345 M5(Y, X) = 1
4350 D9$ = U1$: GOSUB 8110: D9$ = "": GOSUB 8110
4360 RETURN
...
4440 D9$ = U1$: GOSUB 8110: D9$ = "": GOSUB 8110
4445 M5(Y, X) = 0
4450 D9$ = U1$: GOSUB 8110: D9$ = "": GOSUB 8110
4460 RETURN
...
12137 POKE UH, 0: POKE UH, 0: GOSUB 8200
